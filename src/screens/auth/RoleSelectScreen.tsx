      ...
      >
        ...
        {institute && (
          <SelectedInstituteCard
            institute={{
              name: institute.name,
              logo: getInstituteLogoByName(institute.name),
              city: institute.city,
        ...
        {error ? (
          <View style={styles.errorRow}>
            <AppIcons.AlertCircle
              ...
              strokeWidth={2}
            />
            <Text testID="roleErrorText" style={[styles.errorText, { color: colors.errorText }]}>
              {error}
            </Text>
          </View>
        ) : null}
        ...
        {roles.length === 0 ? (
          <Text testID="emptyRoleMessage" style={[styles.emptyText, { color: colors.textMuted }]}>
